    ...
    >
      <section
        className="bg-white max-w-[42rem] border border-black/5 
            ...
            even:pl-8 hover:bg-gray-200 transition dark:text-white dark:bg-white/10 dark:hover:bg-white/20"
      >
        <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]">
          ...
          <Image
            ...
            quality={95}
            className="
          invisible absolute top-8 -right-40 w-[28.30rem] rounded-t-lg shadow-2xl
          transition  
