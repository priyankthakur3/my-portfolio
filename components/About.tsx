...
export default function About() {
  ...
  return (
    <section
      ref={ref}
      id="aboutme"
      className="mb-20 max-w-[45rem] text-justify leading-8 sm:mb-40 scroll-mt-[100rem]"
    >
      <motion.div
      ...
      >
        ...
        <p className="mb-3">
          ...
          software engineering, and data analysis. My experience includes
          optimizing ETL pipelines, leading teams. I am Proficient in{" "}
          <span className="underline">Python, JavaScript, SQL, </span> and
          frameworks such as{" "}
          <span className="underline"> Spring Boot, Express.js and Django</span>{" "}
        ...
        <p>
          ...
          video games, watching movies, and playing Batman: Arkham Knight. I
          also enjoy
